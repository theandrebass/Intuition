...
[![Build Status](https://travis-ci.org/theandrebass/intuition.svg?branch=master)](https://travis-ci.org/theandrebass/intuition)
![Dependencies](https://img.shields.io/badge/dependencies-up%20to%20date-brightgreen.svg)
[![GitHub Issues](https://img.shields.io/github/issues/theandrebass/intuition.svg)](https://github.com/theandrebass/intuition/issues)
...
```bash
python -m pip install git+https://github.com/theandrebass/intuition
```
...
```python
from intuition.engine import Backtest
import pandas as pd
...
```text
https://github.com/theandrebass/gemini
```
...
```text
https://github.com/theandrebass/stocktalk
```
...
## Contributing
Please take a look at our [contributing](https://github.com/theandrebass/intuition/blob/master/CONTRIBUTING.md) guidelines if you're interested in helping!
#### Pending Features
- Export model
